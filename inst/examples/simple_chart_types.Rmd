...
```{r}
scatter<-specify_base(chart_type="scatter",data="tab_dat",y="country",x="site.id")
plot(scatter)
```
...
#visualize
spatial_chart<-specify_base(chart_type="choropleth",
                            data="shape_dat",
...
spatial_chart<-specify_base(chart_type="choropleth",data="gin_shape_dat",metadata = "tab",color="admin0Name",alpha="n")
plot(spatial_chart)
```
