...
```{r unaligned_mtcars, message=FALSE, warning=FALSE}
...
```{r color_aligned_mtcars, message=FALSE, warning=FALSE}
...
scatter_chart <- specify_single(chart_type = "scatter", data = "mtcars_dat", x = "wt", y = "am")

scatter_chart_two <- specify_single(chart_type = "scatter", data = "mtcars_dat", x = "wt", y = "am")

bar_alt <- specify_single(chart_type = "bar", data = "mtcars_dat", x = "am", y = "wt", rm_x_label=TRUE)
...
# Specify bar chart:
bar_chart <- specify_single(chart_type = "bar", data = "mtcars_dat", x = "am", y = "mpg")
plot(bar_chart)

# Specify box plot:
boxplot_chart <- specify_single(chart_type = "boxplot", data = "mtcars_dat", x = "am", y = "mpg")
plot(boxplot_chart)

# Scatter plot:
scatter_chart <- specify_single(chart_type = "scatter", data = "mtcars_dat", x = "hp", y = "mpg")
plot(scatter_chart)

spatial_aligned_combo2 <- specify_combination(combo_type = "spatial_aligned",
                                       base_charts = c("bar_chart", "boxplot_chart", "scatter_chart"))

# Plot
plot(spatial_aligned_combo2)

# Error #2:

#This has error: Error in do.call(plot_simple, args = leadChart_baseSpecs, envir = parent.frame()) : second argument must be a list

spatial_aligned_combo3 <- specify_combination(combo_type = "spatial_aligned",
                                       base_charts = c("bar_chart", "boxplot_chart", "bar_alt"))

# Plot
plot(spatial_aligned_combo3)
