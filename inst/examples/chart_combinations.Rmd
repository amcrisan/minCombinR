...
scatter_chart <- specify_single(chart_type = "scatter", data = "tab_dat", x = "month", y = "site.id")
...
*This example will have an error because pie charts cannot be part of spatial aligned combinations*
...
```{r}
# Specifications
bar_alt <- specify_single(chart_type = "bar", data = "tab_dat", x = "site.id", y = "month", rm_x_label=TRUE)
